...
/* SYSC register to control the USB PM domain. */
#define SYS_USB_PWRRDY		0xd70
/* Firmware function identifier to control USB PM domain. */
#define RZG3S_FW_SIP_ID		0x82000014
...
static const struct rzg2l_cpg_pm_domain_init_data r9a08g045_pm_domains[] = {
	...
	DEF_PD("always-on",	R9A08G045_PD_ALWAYS_ON,
				DEF_REG_CONF(0, 0),
				RZG2L_PD_PARENT_ROOT, RZG2L_PD_F_ALWAYS_ON),
	DEF_PD("gic",		R9A08G045_PD_GIC,
				DEF_REG_CONF(CPG_BUS_ACPU_MSTOP, BIT(3)),
				RZG2L_PD_PARENT_DEFAULT, RZG2L_PD_F_ALWAYS_ON),
	...
	DEF_PD("usb",		RZG3S_PD_USB,
				DEF_REG_CONF_COOKIE(SYS_USB_PWRRDY, BIT(0), RZG3S_FW_SIP_ID),
				RZG2L_PD_PARENT_DEFAULT, RZG2L_PD_F_NONE),
