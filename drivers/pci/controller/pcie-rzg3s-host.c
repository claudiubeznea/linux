 ...
 * the other action or reset function being executed (later) with clocks
 * disabled; this leads to system being blocked and eventually restarted by
 * watchdog
...
static int rzg3s_pcie_probe_helper(struct platform_device *pdev,
				   void *devres_group_id)
{
